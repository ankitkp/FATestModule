...
public class Q14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //"14.	Have teachers/health visitors ever expressed any concerns about his/her development?"
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Q14.this,"Please select an option",Toast.LENGTH_LONG).show();
                }
                else {
                    ...
                    Intent i = new Intent(Q14.this, Q15.class);
