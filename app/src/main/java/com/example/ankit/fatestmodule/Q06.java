...
public class Q06 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //"6.	Does s/hehe or she have any unusual and repetitive movements?"
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Q06.this,"Please select an option",Toast.LENGTH_LONG).show();
                }
                else {
                    ...
                    Intent i = new Intent(Q06.this, Q07.class);
