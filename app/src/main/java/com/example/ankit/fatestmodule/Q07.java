...
public class Q07 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //"7.	Does s/he point with one finger to ask for something or to get help?"
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Q07.this,"Please select an option",Toast.LENGTH_LONG).show();
                }
                else {
                    ...
                    Intent i = new Intent(Q07.this, Q08.class);
