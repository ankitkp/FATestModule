...
public class Q09 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //"9.	When you smile at your child, does s/he smile back at you?"
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Q09.this,"Please select an option",Toast.LENGTH_LONG).show();
                }
                else {
                    ...
                    Intent i = new Intent(Q09.this, Q10.class);
