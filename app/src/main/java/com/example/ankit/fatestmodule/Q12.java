...
public class Q12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //"12.	Does your child understand when you tell him or her to do something?"
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Q12.this,"Please select an option",Toast.LENGTH_LONG).show();
                }
                else {
                    ...
                    Intent i = new Intent(Q12.this, Q13.class);
